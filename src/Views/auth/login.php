    ...
    <div class="relative min-h-screen flex items-center justify-center p-4">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-white/80 mt-2">Sistem Organisasi Materi Kuliah</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-8">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-500 mt-2">Masuk dengan akun Google Mahasiswa Anda</p>
                </div>
                ...
                <!-- Google Login Button -->
                <a href="<?= $authUrl ?>"
                    class="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-white border-2 border-gray-200 rounded-xl text-gray-700 font-medium hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 shadow-sm">
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-500">
                        Gunakan email <strong>@mhs.politala.ac.id</strong>
                    </p>
                </div>
            </div>

            <!-- Features -->
            <div class="mt-8 grid grid-cols-3 gap-4 text-center text-white/90">
                <div class="p-4">
                    <i class="fas fa-cloud-upload-alt text-2xl mb-2"></i>
                    <p class="text-xs">Upload ke Drive</p>
                </div>
                <div class="p-4">
                    <i class="fas fa-folder-open text-2xl mb-2"></i>
                    <p class="text-xs">Terorganisir</p>
                </div>
                <div class="p-4">
                    <i class="fas fa-bell text-2xl mb-2"></i>
                    <p class="text-xs">Notifikasi</p>
                </div>
            </div>

            <!-- Footer -->
            <div class="mt-8 text-center text-white/60 text-sm">
                <p>&copy; <?= date('Y') ?> Politeknik Negeri Tanah Laut</p>
            </div>
        </div>
    </div>
</body>
